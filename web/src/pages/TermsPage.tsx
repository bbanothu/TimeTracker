    ...
    <LegalPageLayout title="Terms of Service" updated="July 5, 2026">
      ...
      <LegalSection title="Acceptable use">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>Use Tempo for unlawful purposes or to violate others&apos; rights</li>
      ...
      <LegalSection title="Disclaimer">
        <p>
          Tempo is provided &ldquo;as is&rdquo; without warranties of any kind. We do not guarantee
